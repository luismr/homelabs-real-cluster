...
- **Network**: All machines on the same subnet (192.168.7.0/24 in this guide)
...
- **Subnet**: 192.168.7.0/24 (255.255.255.0)
- **Master**: 192.168.7.200
- **Workers**: 192.168.7.201-203
- **DNS**: 8.8.8.8, 8.8.4.4 (or your local DNS)
...
network:
  ...
  ethernets:
    enp0s3:  # Replace with your interface name
      dhcp4: false
      addresses:
        - 192.168.7.200/24  # Change per machine
      gateway4: 192.168.7.1  # Your gateway
      nameservers:
        addresses:
          - 8.8.8.8
          - 8.8.4.4
